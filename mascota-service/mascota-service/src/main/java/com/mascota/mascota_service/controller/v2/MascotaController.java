...
public class MascotaController {
    ...
    public ResponseEntity<EntityModel<MascotaDTO>> crearMascota(@PathVariable Integer userid,
            @Valid @RequestBody String nombre, Integer idtipo) {
    ...
    public ResponseEntity<EntityModel<MascotaDTO>> actualizarExp(@PathVariable int afectaExpBase,
